...
```{r}
txt1 <- t(
  read.csv("/Users/ryker/Critical Habitats Project/BHS 2008/BigHornSheep_2008/Unit1_2008.txt", header = FALSE, sep = ";")) # transposed to long
txt1_df <- as.data.frame(txt1) # convert to df
txt1_df$Unit <- "1" # add area unit


txt2 <- t(
  read.csv("/Users/ryker/Critical Habitats Project/BHS 2008/BigHornSheep_2008/Unit2A_2008.txt", header = FALSE, sep = ";"))
txt2_df <- as.data.frame(txt2) 
txt2_df$Unit <- "2"

txt3 <- t(
  read.csv("/Users/ryker/Critical Habitats Project/BHS 2008/BigHornSheep_2008/Unit2B_2008.txt", header = FALSE, sep = ";"))
txt3_df <- as.data.frame(txt3) 
txt3_df$Unit <- "3"

txt4 <- t(
  read.csv("/Users/ryker/Critical Habitats Project/BHS 2008/BigHornSheep_2008/Unit3_2008.txt", header = FALSE, sep = ";"))
...
```{r}
`Bighorn Sheep Habitat` <- bhs_sf # rename for legend title
